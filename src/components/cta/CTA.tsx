...
export default function CTA() {
  return (
    <section className="container mb-20 py-16">
      <div className="group flex cursor-pointer select-none justify-between overflow-hidden rounded-xl bg-primary text-white shadow-2xl hover:border-b-4 hover:border-white active:border-none active:shadow-none">
        <div className="flex max-w-2xl flex-1 flex-col justify-between px-10 py-10">
